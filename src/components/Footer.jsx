...
const Footer = () => (
  <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    <div className={`${styles.flexCenter} md:flex-row flex-col mb-8 w-full border-b-[1px] border-b-[#3F3E45]`}>
      <div className="flex-[1] flex flex-col justify-center mr-10">
        ...
        <p className={`${styles.paragraph} mt-4 max-w-[600px]`}>
          Pedal your way to adventure: conquer new paths and embrace the joy of
          cycling anywhere life takes you
        </p>
      </div>
    ...
    className="w-full  flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3F3E45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white">
        Copyright Ⓒ 2024 Cycling. All Rights Reserved.
      </p>
